...
DEPRECATED FEATURE (see https://github.com/gocnpan/kubo/issues/9717)
...
// (avoiding issues described in https://github.com/gocnpan/kubo/issues/7939)
...
func urlArgsDecoder(req *cmds.Request, env cmds.Environment) error {
	for n, arg := range req.Arguments {
		...
		// - without this we get data corruption similar to https://github.com/gocnpan/kubo/issues/7939
