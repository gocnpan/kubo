...
func (swarmLimits) UnmarshalJSON(b []byte) error {
	...
	for {
		...
		case nil:
			...
			//nolint
			return fmt.Errorf("The Swarm.ResourceMgr.Limits configuration has been removed in Kubo 0.19 and should be empty or not present. To set custom libp2p limits, read https://github.com/gocnpan/kubo/blob/master/docs/libp2p-resource-management.md#user-supplied-override-limits")
		default:
			return err
		}
	}
...
func (graphsyncEnabled) UnmarshalJSON(b []byte) error {
	...
	for {
		...
		case nil:
			...
			//nolint
			return fmt.Errorf("Support for Experimental.GraphsyncEnabled has been removed in Kubo 0.25.0, please remove this key. For more details see https://github.com/gocnpan/kubo/pull/9747.")
		default:
			return err
		}
	}
