...
`)
	...
	if !offline {
		// Warn users who were victims of 'lowprofile' footgun (https://github.com/gocnpan/kubo/pull/10524)
...
func serveHTTPApi(req *cmds.Request, cctx *oldcmds.Context) (<-chan error, error) {
	...
	for _, listener := range listeners {
		...
		case "tcp", "tcp4", "tcp6":
			...
			// https://github.com/gocnpan/kubo/issues/10515
...
Visit https://github.com/gocnpan/kubo/releases or https://dist.ipfs.tech/#kubo and update to version %s or later.`,
