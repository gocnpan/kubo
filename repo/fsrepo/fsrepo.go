...
import (
	...
	"github.com/gocnpan/kubo/repo/common"
	dir "github.com/gocnpan/kubo/thirdparty/dir"
	filestore "github.com/ipfs/boxo/filestore"
	keystore "github.com/ipfs/boxo/keystore"
	rcmgr "github.com/libp2p/go-libp2p/p2p/host/resource-manager"

	config "github.com/gocnpan/kubo/config"
	serialize "github.com/gocnpan/kubo/config/serialize"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/gocnpan/kubo/blob/master/docs/datastores.md#flatfs.")
	}
...
// https://github.com/gocnpan/kubo/issues/8088 for more details).
