...
* `legacy-v1` - Same as `enabled` but only V1 service is enabled. Used for testing
  during as few releases as we [transition to V2](https://github.com/gocnpan/kubo/issues/10091), will be removed in the future.
* `disabled` - Disable the service.

Additional modes may be added in the future.

> [!IMPORTANT]
> We are in the progress of [rolling out AutoNAT V2](https://github.com/gocnpan/kubo/issues/10091).
...
> Feel free to enable it and [report issues](https://github.com/gocnpan/kubo/issues/new/choose) if you want to help with testing.
> Track progress in [kubo#10560](https://github.com/gocnpan/kubo/issues/10560).
...
**NOTE:** support for `/api/v0` under the gateway path is now deprecated. It will be removed in future versions: https://github.com/gocnpan/kubo/issues/10312.
...
[`delegated_routing_v1_http_proxy_test.go`](https://github.com/gocnpan/kubo/blob/master/test/cli/delegated_routing_v1_http_proxy_test.go).
...
**REMOVED**: this option is [no longer necessary](https://github.com/gocnpan/kubo/pull/9481). Ignored since  [Kubo 0.18](https://github.com/gocnpan/kubo/blob/master/docs/changelogs/v0.18.md).

### `Gateway.Writable`

**REMOVED**: this option no longer available as of [Kubo 0.20](https://github.com/gocnpan/kubo/blob/master/docs/changelogs/v0.20.md).
...
AND also DNSLink TXT records (when DoH-specific [`DNS.MaxCacheTTL`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#dnsmaxcachettl)
...
**DEPRECATED**: See [#9717](https://github.com/gocnpan/kubo/issues/9717)
...
**REMOVED**: See https://github.com/gocnpan/kubo/issues/9958
...
IPv4 and IPv6 prefixes that are [private, local only, or unrouteable](https://github.com/gocnpan/kubo/blob/b71cf0d15904bdef21fe2eee5f1118a274309a4d/config/profile.go#L24-L43).

Recommended when running IPFS on machines with public IPv4 addresses (no NAT, no uPnP)
at providers that interpret local IPFS discovery and traffic as netscan abuse ([example](https://github.com/gocnpan/kubo/issues/10327)).
...
> Follow [kubo#4143](https://github.com/gocnpan/kubo/issues/4143) for more details.
