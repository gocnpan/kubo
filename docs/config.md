...
This endpoint can be used by other Kubo instance, as illustrated in [`delegated_routing_v1_http_proxy_test.go`](https://github.com/gocnpan/kubo/blob/master/test/cli/delegated_routing_v1_http_proxy_test.go).
