<!-- Last updated during [v0.18.0 release](https://github.com/gocnpan/kubo/issues/9417) -->
...
- Check the issues with the `help wanted` label in the [ipfs/kubo repo](https://github.com/gocnpan/kubo/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)
