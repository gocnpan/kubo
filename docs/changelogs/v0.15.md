...
Extra plugin info [here](https://github.com/gocnpan/kubo/blob/master/docs/plugins.md#fx-experimental).

#### 📁 `$IPFS_PATH/gateway` file

This adds a new file in the `IPFS_PATH` folder similar to `$IPFS_PATH/api` containing an address based on [`Addresses.Gateway`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#addressesgateway) configuration.
...
- github.com/gocnpan/kubo:
  ...
  - feat: make corehttp a reusable component ([ipfs/kubo#9070](https://github.com/gocnpan/kubo/pull/9070))
  - feat: go-libp2p v0.21 (rcmgr auto scaling) ([ipfs/kubo#9074](https://github.com/gocnpan/kubo/pull/9074))
  -  ([ipfs/kubo#9024](https://github.com/gocnpan/kubo/pull/9024))
  -  ([ipfs/kubo#9100](https://github.com/gocnpan/kubo/pull/9100))
  -  ([ipfs/kubo#9095](https://github.com/gocnpan/kubo/pull/9095))
  - chore(cmd): add shutdown to CLI help ([ipfs/kubo#9194](https://github.com/gocnpan/kubo/pull/9194))
  - docs: add fx plugin documentation to plugins.md (#9191) ([ipfs/kubo#9191](https://github.com/gocnpan/kubo/pull/9191))
  - chore: switch to dist.ipfs.tech
  - feat: add fx options plugin
  - feat: add blake3 support
  - Add reference to Experimental config doc (#9181) ([ipfs/kubo#9181](https://github.com/gocnpan/kubo/pull/9181))
  - feat: add $IPFS_PATH/gateway file
  - docs: replace `docs.ipfs.io` with `docs.ipfs.tech` (#9158) ([ipfs/kubo#9158](https://github.com/gocnpan/kubo/pull/9158))
  ...
  - docs(readme): add maintainer info (#9141) ([ipfs/kubo#9141](https://github.com/gocnpan/kubo/pull/9141))
  - fix(gw): 404 when a valid DAG is missing link
  - fix(gw): directory URL normalization ([ipfs/kubo#9123](https://github.com/gocnpan/kubo/pull/9123))
  ...
  - docs(readme): move content to docs website (#9102) ([ipfs/kubo#9102](https://github.com/gocnpan/kubo/pull/9102))
