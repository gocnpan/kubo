...
For details see [#9927](https://github.com/gocnpan/kubo/issues/9927) and [#10020](https://github.com/gocnpan/kubo/pull/10020).
...
- github.com/gocnpan/kubo:
  ...
  - chore: remove sharness tests ported to conformance testing (#9999) ([ipfs/kubo#9999](https://github.com/gocnpan/kubo/pull/9999))
  - ci: switch from testing against js-ipfs to helia (#10042) ([ipfs/kubo#10042](https://github.com/gocnpan/kubo/pull/10042))
  - chore: merge release back into master
  - chore: change orbitdb to haydenyoung EARLY_TESTERS
  - Fix usage numbers
  - chore: update early testers list (#9218) ([ipfs/kubo#9218](https://github.com/gocnpan/kubo/pull/9218))
  - docs: changelog v0.21 fixes (#10037) ([ipfs/kubo#10037](https://github.com/gocnpan/kubo/pull/10037))
  - refactor(ci): simplify Dockerfile and add docker image testing (#10021) ([ipfs/kubo#10021](https://github.com/gocnpan/kubo/pull/10021))
  ...
  - fix: mark all routers DoNotWaitForSearchValue (#10020) ([ipfs/kubo#10020](https://github.com/gocnpan/kubo/pull/10020))
  - feat(gateway): support for ipip-412 parameters
  - docs(commands): explain that swarm connect can reuse existing connections or known addresses (#10015) ([ipfs/kubo#10015](https://github.com/gocnpan/kubo/pull/10015))
  - docs: add Brave to RELEASE_ISSUE_TEMPLATE.md (#10012) ([ipfs/kubo#10012](https://github.com/gocnpan/kubo/pull/10012))
  - feat: webui@4.0.2
  -  ([ipfs/kubo#10008](https://github.com/gocnpan/kubo/pull/10008))
  ...
  - fix(gateway): include CORS on subdomain redirects (#9994) ([ipfs/kubo#9994](https://github.com/gocnpan/kubo/pull/9994))
  - fix: docker repository initialization race condition
  - feat(ipns): records with V2-only signatures (#9932) ([ipfs/kubo#9932](https://github.com/gocnpan/kubo/pull/9932))
  - cmds/dag/import: pin roots by default (#9966) ([ipfs/kubo#9966](https://github.com/gocnpan/kubo/pull/9966))
  - docs: fix 0.21 changelog
  - feat!: dag import - don't pin roots by default (#9926) ([ipfs/kubo#9926](https://github.com/gocnpan/kubo/pull/9926))
  - fix(cmd): useful errors in dag import (#9945) ([ipfs/kubo#9945](https://github.com/gocnpan/kubo/pull/9945))
  - feat: webui@4.0.1 (#9940) ([ipfs/kubo#9940](https://github.com/gocnpan/kubo/pull/9940))
  - chore(docs): typo http→https
  - fix: more stable prometheus test (#9944) ([ipfs/kubo#9944](https://github.com/gocnpan/kubo/pull/9944))
  -  ([ipfs/kubo#9937](https://github.com/gocnpan/kubo/pull/9937))
