...
Learn more: [`Swarm.Transports.Network.WebRTCDirect`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#swarmtransportsnetworkwebrtcdirect)
...
For more details, see the [Deployment Plan for AutoNAT V2](https://github.com/gocnpan/kubo/issues/10091) and [`AutoNAT`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#autonat) configuration options.
...
- To disable automated checks, set [`Version.SwarmCheckEnabled`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#versionswarmcheckenabled) to `false`.

#### Version Suffix Configuration

Defining the optional agent version suffix is now simpler. The [`Version.AgentSuffix`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#agentsuffix) value from the Kubo config takes precedence over any value provided via `ipfs daemon --agent-version-suffix` (which is still supported).
...
- github.com/gocnpan/kubo:
  ...
  - chore: fix function name (#10481) ([ipfs/kubo#10481](https://github.com/gocnpan/kubo/pull/10481))
  - feat: Support storing UnixFS 1.5 Mode and ModTime (#10478) ([ipfs/kubo#10478](https://github.com/gocnpan/kubo/pull/10478))
  - fix(rpc): cross-platform support for /unix/ socket maddrs in Addresses.API ([ipfs/kubo#10019](https://github.com/gocnpan/kubo/pull/10019))
  - chore(daemon): sort listeners (#10480) ([ipfs/kubo#10480](https://github.com/gocnpan/kubo/pull/10480))
  - feat(daemon): improve stdout on startup (#10472) ([ipfs/kubo#10472](https://github.com/gocnpan/kubo/pull/10472))
  - fix(daemon): panic in kubo/daemon.go:595 (#10473) ([ipfs/kubo#10473](https://github.com/gocnpan/kubo/pull/10473))
  - feat: webui v4.3.0 (#10477) ([ipfs/kubo#10477](https://github.com/gocnpan/kubo/pull/10477))
  - docs(readme): add Gentoo Linux (#10474) ([ipfs/kubo#10474](https://github.com/gocnpan/kubo/pull/10474))
  - libp2p: default to prefering TLS ([ipfs/kubo#10227](https://github.com/gocnpan/kubo/pull/10227))
  - docs: document unofficial Ubuntu PPA ([ipfs/kubo#10467](https://github.com/gocnpan/kubo/pull/10467))
  - feat: run AutoNAT V2 service in addition to V1 (#10468) ([ipfs/kubo#10468](https://github.com/gocnpan/kubo/pull/10468))
  - feat: go-libp2p 0.36 and /webrtc-direct listener (#10463) ([ipfs/kubo#10463](https://github.com/gocnpan/kubo/pull/10463))
  - chore: update dependencies (#10462)(#10466) ([ipfs/kubo#10466](https://github.com/gocnpan/kubo/pull/10466))
  - feat: periodic version check and json config (#10438) ([ipfs/kubo#10438](https://github.com/gocnpan/kubo/pull/10438))
  - docs: clarify pnet limitations
  - docs: "error mounting: could not resolve name" (#10449) ([ipfs/kubo#10449](https://github.com/gocnpan/kubo/pull/10449))
  - docs: update ipfs-swarm-key-gen example (#10453) ([ipfs/kubo#10453](https://github.com/gocnpan/kubo/pull/10453))
  - chore: update deps incl. boxo v0.21.0 (#10444) ([ipfs/kubo#10444](https://github.com/gocnpan/kubo/pull/10444))
  - chore: go-libp2p 0.35.1 (#10430) ([ipfs/kubo#10430](https://github.com/gocnpan/kubo/pull/10430))
  - docsa: update RELEASE_CHECKLIST.md
  - chore: create next changelog (#10443) ([ipfs/kubo#10443](https://github.com/gocnpan/kubo/pull/10443))
  - Merge Release: v0.29.0 [skip changelog] ([ipfs/kubo#10442](https://github.com/gocnpan/kubo/pull/10442))
  ...
  - chore: fix some typos (#10396) ([ipfs/kubo#10396](https://github.com/gocnpan/kubo/pull/10396))
  - chore: update version
