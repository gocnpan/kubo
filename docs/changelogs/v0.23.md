...
but can be enabled by setting [`Gateway.ExposeRoutingAPI`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#gatewayexposeroutingapi) to `true` .
...
See [HTTP Gateway over Libp2p](https://github.com/gocnpan/kubo/blob/master/docs/experimental-features.md#http-gateway-over-libp2p) for details about this experiment.
...
In [Kubo 0.18](https://github.com/gocnpan/kubo/releases/tag/v0.18.0), we shipped a migration
...
the `/quic-v1` addresses only. For more background information, check [issue #9496](https://github.com/gocnpan/kubo/issues/9496).
...
`ls`ing directories and reading dag-pb files on a fuse volume have been fixed. [#9044](https://github.com/gocnpan/kubo/issues/9044)
...
- github.com/gocnpan/kubo:
  - fix: align systemd unit file with default IPFS installation path (#10163) ([ipfs/kubo#10163](https://github.com/gocnpan/kubo/pull/10163))
  ...
  - docs(readme): header improvements (#10144) ([ipfs/kubo#10144](https://github.com/gocnpan/kubo/pull/10144))
  - fix(docker): allow nofuse builds for MacOS (#10135) ([ipfs/kubo#10135](https://github.com/gocnpan/kubo/pull/10135))
  - docs: fix typos
  ...
  - chore: webui v4.1.1 (#10120) ([ipfs/kubo#10120](https://github.com/gocnpan/kubo/pull/10120))
  - core/bootstrap: fix panic without backup bootstrap peer functions (#10029) ([ipfs/kubo#10029](https://github.com/gocnpan/kubo/pull/10029))
  - feat: add Gateway.DisableHTMLErrors option (#10137) ([ipfs/kubo#10137](https://github.com/gocnpan/kubo/pull/10137))
  - fix(migrations): use dweb.link (#10133) ([ipfs/kubo#10133](https://github.com/gocnpan/kubo/pull/10133))
  - docs: add changelog info for QUIC Draft 29 (#10132) ([ipfs/kubo#10132](https://github.com/gocnpan/kubo/pull/10132))
  - feat: add gateway to http over libp2p ([ipfs/kubo#10108](https://github.com/gocnpan/kubo/pull/10108))
  ...
  - fix: hamt traversal in ipld-explorer (webui@4.1.0) (#10025) ([ipfs/kubo#10025](https://github.com/gocnpan/kubo/pull/10025))
  - refactor: if statement (#10105) ([ipfs/kubo#10105](https://github.com/gocnpan/kubo/pull/10105))
  - chore: bump repo version to 15
  - docs: remove link to deleted #accelerated-dht-client
  - feat(gateway): expose /routing/v1 server (opt-in) (#9877) ([ipfs/kubo#9877](https://github.com/gocnpan/kubo/pull/9877))
  - improve error in fuse node failures
  - chore: update boxo, go-libp2p, and internalize mplex (#10095) ([ipfs/kubo#10095](https://github.com/gocnpan/kubo/pull/10095))
  - dockerfile: reorder copy order for better layer caching
  - refactor: using error is instead of == (#10093) ([ipfs/kubo#10093](https://github.com/gocnpan/kubo/pull/10093))
  ...
  - chore: restore exec perms for t0116-gateway-cache.sh and fixtures (#10085) ([ipfs/kubo#10085](https://github.com/gocnpan/kubo/pull/10085))
  - fix(gw): useful IPIP-402 CARs on not found errors (#10084) ([ipfs/kubo#10084](https://github.com/gocnpan/kubo/pull/10084))
  - feat: add zsh completions (#10040) ([ipfs/kubo#10040](https://github.com/gocnpan/kubo/pull/10040))
  - style: remove commented imports [skip changelog]
  - style: gofumpt and godot [skip changelog] (#10081) ([ipfs/kubo#10081](https://github.com/gocnpan/kubo/pull/10081))
  - chore: bump boxo for verifcid breaking changes
  - chore: remove outdated comment (#10077) ([ipfs/kubo#10077](https://github.com/gocnpan/kubo/pull/10077))
  - chore: remove deprecated testground plans
  - feat: allow users to optin again into mplex
  - feat: remove Mplex
  - docs(readme): minimal reqs (#10066) ([ipfs/kubo#10066](https://github.com/gocnpan/kubo/pull/10066))
  - docs: add v0.23.md
