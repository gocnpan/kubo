...
Learn more at [`/docs/content-blocking.md`](https://github.com/gocnpan/kubo/blob/master/docs/content-blocking.md)
...
See [`Swarm.Transports.Network.WebRTCDirect`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#swarmtransportsnetworkwebrtcdirect)
...
- github.com/gocnpan/kubo:
  ...
  - Release: v0.24.0-1 ([ipfs/kubo#10190](https://github.com/gocnpan/kubo/pull/10190))
