...
- github.com/gocnpan/kubo:
  ...
  - test(gateway): use deterministic CAR fixtures ([ipfs/kubo#9657](https://github.com/gocnpan/kubo/pull/9657))
  - feat(gateway): error handling improvements (500, 502, 504) (#9660) ([ipfs/kubo#9660](https://github.com/gocnpan/kubo/pull/9660))
  - docs: be clear about swarm.addrfilters (#9661) ([ipfs/kubo#9661](https://github.com/gocnpan/kubo/pull/9661))
  - chore: update go-libp2p to v0.26 (#9656) ([ipfs/kubo#9656](https://github.com/gocnpan/kubo/pull/9656))
  - feat(pinning): connect some missing go context (#9557) ([ipfs/kubo#9557](https://github.com/gocnpan/kubo/pull/9557))
  - fix(gateway): return HTTP 500 on ErrResolveFailed (#9589) ([ipfs/kubo#9589](https://github.com/gocnpan/kubo/pull/9589))
  - docs: bulk spelling edits (#9544) ([ipfs/kubo#9544](https://github.com/gocnpan/kubo/pull/9544))
  - docs: "remote" errors from resource manager (#9653) ([ipfs/kubo#9653](https://github.com/gocnpan/kubo/pull/9653))
  - test: remove gateway tests migrated to go-libipfs
  - fix: update rcmgr for go-libp2p v0.25
  - chore: update go-libp2p to v0.25.1
  - docs(0.18.1): guide users to clean up limits (#9644) ([ipfs/kubo#9644](https://github.com/gocnpan/kubo/pull/9644))
  - feat: add NewOptionalInteger function
  - fix: dereference int64 pointer in OptionalInteger.String() (#9640) ([ipfs/kubo#9640](https://github.com/gocnpan/kubo/pull/9640))
  - fix: restore wire format for /api/v0/routing/get|put (#9639) ([ipfs/kubo#9639](https://github.com/gocnpan/kubo/pull/9639))
  - refactor(gw): move Host (DNSLink and subdomain) handling to go-libipfs (#9624) ([ipfs/kubo#9624](https://github.com/gocnpan/kubo/pull/9624))
  - refactor: new go-libipfs/gateway API, deprecate Gateway.Writable (#9616) ([ipfs/kubo#9616](https://github.com/gocnpan/kubo/pull/9616))
  - Create Changelog: v0.19 ([ipfs/kubo#9617](https://github.com/gocnpan/kubo/pull/9617))
  - refactor: use gateway from go-libipfs (#9588) ([ipfs/kubo#9588](https://github.com/gocnpan/kubo/pull/9588))
  - Merge Release: v0.18.1 ([ipfs/kubo#9613](https://github.com/gocnpan/kubo/pull/9613))
  ...
  - feat(gateway): IPNS record response format (IPIP-351) (#9399) ([ipfs/kubo#9399](https://github.com/gocnpan/kubo/pull/9399))
  - fix(ipns): honour --ttl flag in 'ipfs name publish' (#9471) ([ipfs/kubo#9471](https://github.com/gocnpan/kubo/pull/9471))
  ...
  - Merge Kubo: v0.18 ([ipfs/kubo#9581](https://github.com/gocnpan/kubo/pull/9581))
  ...
  - Update Version (dev): v0.18 ([ipfs/kubo#9500](https://github.com/gocnpan/kubo/pull/9500))
