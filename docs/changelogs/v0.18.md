...
IF you run a server and want to utilize more than half of memory and file descriptors to p2p work, adjust [`Swarm.ResourceMgr.MaxMemory`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#swarmresourcemgrmaxmemory) and [`Swarm.ResourceMgr.MaxFileDescriptors`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#swarmresourcemgrmaxfiledescriptors).

The 0.18.1 builds on the default protection nodes get against DoS (resource exhaustion) and eclipse attacks
with the [go-libp2p Network Resource Manager/Accountant](https://github.com/gocnpan/kubo/blob/master/docs/libp2p-resource-management.md)
that was fine-tuned in [Kubo 0.18](https://github.com/gocnpan/kubo/blob/biglep/resource-manager-example-of-what-want/docs/changelogs/v0.18.md#improving-libp2p-resource-management-integration).

Adding default hard-limits from the Resource Manager/Accountant after the fact is tricky,
and some additional improvements have been made to improve the [computed defaults](https://github.com/gocnpan/kubo/blob/master/docs/libp2p-resource-management.md#computed-default-limits).
...
- github.com/gocnpan/kubo:
  ...
  - feat: Pubsub.SeenMessagesStrategy (#9543) ([ipfs/kubo#9543](https://github.com/gocnpan/kubo/pull/9543))
...
Learn more in the [`Routing` docs](https://github.com/gocnpan/kubo/blob/master/docs/config.md#routing).
...
[kubo#9326](https://github.com/gocnpan/kubo/pull/9326),
...
[WebTransport](https://docs.libp2p.io/concepts/transports/webtransport/) is a new libp2p transport that [was introduced in v0.16](https://github.com/gocnpan/kubo/blob/master/docs/changelogs/v0.16.md#-webtransport-new-experimental-transport) that is based on top of QUIC and HTTP3.
...
Support for QUIC Draft-29 will be removed at some point in 2023 ([tracking issue](https://github.com/gocnpan/kubo/issues/9496)).  As a result, new deployments should use `/quic-v1` instead of `/quic`.
...
by default in [Kubo 0.17](https://github.com/gocnpan/kubo/blob/master/docs/changelogs/v0.17.md#libp2p-resource-management-enabled-by-default).
...
1. [Dedicated docs concerning the resource manager integration](https://github.com/gocnpan/kubo/blob/master/docs/libp2p-resource-management.md).  This is a great place to go to learn more or get your FAQs answered.
2. Increasing the default limits for the resource manager.
3. Enabling the [`Swarm.ConnMgr`](https://github.com/gocnpan/kubo/blob/master/docs/config.md#swarmconnmgr) by default and reducing it thresholds so it can intelligently prune connections in many cases before the indiscriminate resource manager kicks in.
...
5. [Other miscellaneous config and command bugs reported by users](https://github.com/gocnpan/kubo/issues/9442).
...
- github.com/gocnpan/kubo:
  - fix: clarity: no user supplied rcmgr limits of 0 (#9563) ([ipfs/kubo#9563](https://github.com/gocnpan/kubo/pull/9563))
  - fix(gateway): undesired conversions to dag-json and friends (#9566) ([ipfs/kubo#9566](https://github.com/gocnpan/kubo/pull/9566))
  ...
  - docs: improve docs/README (#9539) ([ipfs/kubo#9539](https://github.com/gocnpan/kubo/pull/9539))
  - test: port CircleCI to GH Actions and improve sharness reporting (#9355) ([ipfs/kubo#9355](https://github.com/gocnpan/kubo/pull/9355))
  - chore: migrate from go-ipfs-files to go-libipfs/files (#9535) ([ipfs/kubo#9535](https://github.com/gocnpan/kubo/pull/9535))
  - fix: stats dht command when Routing.Type=auto (#9538) ([ipfs/kubo#9538](https://github.com/gocnpan/kubo/pull/9538))
  - fix: hint people to changing from RSA peer ids
  - fix(gateway): JSON when Accept is a list
  - fix(test): retry flaky t0125-twonode.sh
  - docs: fix Router config Godoc (#9528) ([ipfs/kubo#9528](https://github.com/gocnpan/kubo/pull/9528))
  - fix(ci): flaky sharness test
  - docs(config): ProviderSearchDelay (#9526) ([ipfs/kubo#9526](https://github.com/gocnpan/kubo/pull/9526))
  ...
  - Removing QRI from early tester ([ipfs/kubo#9503](https://github.com/gocnpan/kubo/pull/9503))
  - fix: disable provide over HTTP with Routing.Type=auto (#9511) ([ipfs/kubo#9511](https://github.com/gocnpan/kubo/pull/9511))
  - Update version.go
  - 'chore: update version.go'
  - Clened up 0.18 changelog for release ([ipfs/kubo#9497](https://github.com/gocnpan/kubo/pull/9497))
  - feat: turn on WebTransport by default ([ipfs/kubo#9492](https://github.com/gocnpan/kubo/pull/9492))
  - feat: fast directory listings with DAG Size column (#9481) ([ipfs/kubo#9481](https://github.com/gocnpan/kubo/pull/9481))
  - feat: add basic CLI tests using Go Test
  - Changelog: v0.18.0 ([ipfs/kubo#9485](https://github.com/gocnpan/kubo/pull/9485))
  ...
  - docs(readme): update package managers section (#9488) ([ipfs/kubo#9488](https://github.com/gocnpan/kubo/pull/9488))
  - fix: support /quic-v1 in webui v0.21
  - feat: Routing.Type=auto (DHT+IPNI) (#9475) ([ipfs/kubo#9475](https://github.com/gocnpan/kubo/pull/9475))
  - feat: adjust ConnMgr target to 32-96 (#9483) ([ipfs/kubo#9483](https://github.com/gocnpan/kubo/pull/9483))
  - feat: increase default Reprovider.Interval (#9326) ([ipfs/kubo#9326](https://github.com/gocnpan/kubo/pull/9326))
  - feat: add response body limiter to routing HTTP client (#9478) ([ipfs/kubo#9478](https://github.com/gocnpan/kubo/pull/9478))
  - docs: libp2p resource management (#9468) ([ipfs/kubo#9468](https://github.com/gocnpan/kubo/pull/9468))
  - chore: upgrade libipfs for routing HTTP API schema changes (#9477) ([ipfs/kubo#9477](https://github.com/gocnpan/kubo/pull/9477))
  ...
  - feat(gateway): JSON and CBOR response formats (IPIP-328) (#9335) ([ipfs/kubo#9335](https://github.com/gocnpan/kubo/pull/9335))
  -  ([ipfs/kubo#9318](https://github.com/gocnpan/kubo/pull/9318))
  - docs: release process updates from v0.17.0 ([ipfs/kubo#9391](https://github.com/gocnpan/kubo/pull/9391))
  - fix(rcmgr): improve error phrasing
  - docs: Update CHANGELOG.md adding 0.17 link
  - feat(config): Pubsub.SeenMessagesTTL (#9372) ([ipfs/kubo#9372](https://github.com/gocnpan/kubo/pull/9372))
  - docs: remove snap and chocolatey packages
  - Merge release v0.17.0 ([ipfs/kubo#9431](https://github.com/gocnpan/kubo/pull/9431))
  - docs: ipfs-http-client -> kubo-rpc-client (#9331) ([ipfs/kubo#9331](https://github.com/gocnpan/kubo/pull/9331))
  - docs(readme): improve tldr
  - Update config.md for resource management limits (#9421) ([ipfs/kubo#9421](https://github.com/gocnpan/kubo/pull/9421))
  ...
  - docs: replace tabcat with aphelionz in EARLY_TESTERS.md (#9404) ([ipfs/kubo#9404](https://github.com/gocnpan/kubo/pull/9404))
  - docs: fix spoiler for 0.13.1 changelog
  - fix(docs): typo
  - chore: bump version to v0.18.0-dev ([ipfs/kubo#9393](https://github.com/gocnpan/kubo/pull/9393))
