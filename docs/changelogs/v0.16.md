...
If you find issues running it please [report them to us](https://github.com/gocnpan/kubo/issues/new).
...
- github.com/gocnpan/kubo:
  ...
  - docs: add WebTransport docs ([ipfs/kubo#9308](https://github.com/gocnpan/kubo/pull/9308))
  - chore: bump version to 0.16.0-rc1
  - fix: ensure hasher is registered when using a hashing function
  - feat: add webtransport as an optin transport ([ipfs/kubo#9293](https://github.com/gocnpan/kubo/pull/9293))
  - feat(gateway): _redirects file support (#8890) ([ipfs/kubo#8890](https://github.com/gocnpan/kubo/pull/8890))
  - docs: fix typo in changelog-v0.16.0.md
  - Readme: Rewrite introduction and featureset (#9211) ([ipfs/kubo#9211](https://github.com/gocnpan/kubo/pull/9211))
  - feat: Delegated routing with custom configuration. (#9274) ([ipfs/kubo#9274](https://github.com/gocnpan/kubo/pull/9274))
  - Add <protocols> to `ipfs id -h` options (#9229) ([ipfs/kubo#9229](https://github.com/gocnpan/kubo/pull/9229))
  - chore: bump go-libp2p v0.23.1 ([ipfs/kubo#9285](https://github.com/gocnpan/kubo/pull/9285))
  - feat(cmds/add): --to-files option automates files cp (#8927) ([ipfs/kubo#8927](https://github.com/gocnpan/kubo/pull/8927))
  - docs: fix broken ENS DoH example (#9281) ([ipfs/kubo#9281](https://github.com/gocnpan/kubo/pull/9281))
  -  ([ipfs/kubo#9258](https://github.com/gocnpan/kubo/pull/9258))
  -  ([ipfs/kubo#9213](https://github.com/gocnpan/kubo/pull/9213))
  - docs: small typo in Dockerfile
  - feat: ipfs-webui v2.18.1
  - feat: ipfs-webui v2.18.0 (#9262) ([ipfs/kubo#9262](https://github.com/gocnpan/kubo/pull/9262))
  - bump go-libp2p v0.22.0 & go1.18&go1.19 ([ipfs/kubo#9244](https://github.com/gocnpan/kubo/pull/9244))
  ...
  - chore: Release v0.15.0 ([ipfs/kubo#9236](https://github.com/gocnpan/kubo/pull/9236))
  - chore: fix undiallable api and gateway files ([ipfs/kubo#9233](https://github.com/gocnpan/kubo/pull/9233))
