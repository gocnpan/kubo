...
# (regression test for https://github.com/gocnpan/kubo/issues/9983#issuecomment-1599673976)
test_expect_success "OPTIONS to Gateway succeeds" '
...
# current state. Fixing CORS on /api/v0 (RPC and Gateway port) is tracked in https://github.com/gocnpan/kubo/issues/7667
