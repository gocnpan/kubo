...
.PHONY: github.com/gocnpan/kubo/test/dependencies/pollEndpoint
$(d)/pollEndpoint: github.com/gocnpan/kubo/test/dependencies/pollEndpoint
	$(go-build-testdep)
TGTS_$(d) += $(d)/pollEndpoint

.PHONY: github.com/gocnpan/kubo/test/dependencies/go-sleep
$(d)/go-sleep: github.com/gocnpan/kubo/test/dependencies/go-sleep
	$(go-build-testdep)
TGTS_$(d) += $(d)/go-sleep

.PHONY: github.com/gocnpan/kubo/test/dependencies/go-timeout
$(d)/go-timeout: github.com/gocnpan/kubo/test/dependencies/go-timeout
	$(go-build-testdep)
TGTS_$(d) += $(d)/go-timeout

.PHONY: github.com/gocnpan/kubo/test/dependencies/iptb
$(d)/iptb: github.com/gocnpan/kubo/test/dependencies/iptb
	$(go-build-testdep)
TGTS_$(d) += $(d)/iptb

.PHONY: github.com/gocnpan/kubo/test/dependencies/ma-pipe-unidir
$(d)/ma-pipe-unidir: github.com/gocnpan/kubo/test/dependencies/ma-pipe-unidir
	$(go-build-testdep)
TGTS_$(d) += $(d)/ma-pipe-unidir

.PHONY: github.com/gocnpan/kubo/test/dependencies/json-to-junit
$(d)/json-to-junit: github.com/gocnpan/kubo/test/dependencies/json-to-junit
	$(go-build-testdep)
